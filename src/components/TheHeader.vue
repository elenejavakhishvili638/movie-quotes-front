...
<template>
  <div class="flex justify-between lg:px-4.375 px-1 pt-1.5 items-center">
    <h1 class="text-cream text-xl uppercase">{{ $t('landing.title') }}</h1>
    <div class="flex items-center">
      ...
      <div class="flex">
        ...
        <button
          @click="props.login"
          class="justify-center items-center flex h-2 border w-4.5 md:w-6 border-white rounded text-white text-sm"
        >
          {{ $t('texts.log_in') }}
        </button>
      </div>
